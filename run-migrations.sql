-- Complete database setup for Aurealis Cosmetics
...
-- Migration 2: Indexes and Triggers
-- Create indexes for better performance
CREATE INDEX IF NOT EXISTS idx_users_email ON public.users(email);
CREATE INDEX IF NOT EXISTS idx_users_sariee_user_id ON public.users(sariee_user_id);
CREATE INDEX IF NOT EXISTS idx_products_sariee_product_id ON public.products(sariee_product_id);
CREATE INDEX IF NOT EXISTS idx_products_sku ON public.products(sku);
CREATE INDEX IF NOT EXISTS idx_products_is_active ON public.products(is_active);
CREATE INDEX IF NOT EXISTS idx_products_is_featured ON public.products(is_featured);
CREATE INDEX IF NOT EXISTS idx_categories_sariee_category_id ON public.categories(sariee_category_id);
